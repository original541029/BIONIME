...
!function (t, i) {
  "function" == typeof define && define.amd ? define("pnotify", ["jquery"], function (s) {
    return i(s, t);
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = i(require("jquery"), global || t) : t.PNotify = i(t.jQuery, t);
}("undefined" != typeof window ? window : void 0, function (t, i) {
  var s = function s(i) {
    var e,
        o,
        n = {
    ...
    return t.extend(c.prototype, {
      ...
      runModules: function runModules(t, i) {
        ...
        for (var e in this.modules) {
          s = "object" == _typeof(i) && e in i ? i[e] : i, "function" == typeof this.modules[e][t] && (this.modules[e].notice = this, this.modules[e].options = "object" == _typeof(this.options[e]) ? this.options[e] : {}, this.modules[e][t](this, "object" == _typeof(this.options[e]) ? this.options[e] : {}, s));
        }
      },
      init: function init() {
        var i = this;
      ...
      parseOptions: function parseOptions(i, s) {
        ...
        for (var e, o = [i, s], n = 0; n < o.length && void 0 !== (e = o[n]); n++) {
          if ("object" != _typeof(e)) this.options.text = e;else for (var a in e) {
...
!function (o, s) {
  "function" == typeof define && define.amd ? define("pnotify.buttons", ["jquery", "pnotify"], s) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = s(require("jquery"), require("./pnotify")) : s(o.jQuery, o.PNotify);
...
!function (i, t) {
  "function" == typeof define && define.amd ? define("pnotify.desktop", ["jquery", "pnotify"], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t(require("jquery"), require("./pnotify")) : t(i.jQuery, i.PNotify);
}("undefined" != typeof window ? window : void 0, function (i, t) {
  var o,
      _n = function n(i, t) {
  ...
  return t.prototype.options.desktop = {
    ...
    genNotice: function genNotice(i, t) {
      null === t.icon ? this.icon = "http://sciactive.com/pnotify/includes/desktop/" + i.options.type + ".png" : !1 === t.icon ? this.icon = null : this.icon = t.icon, null !== this.tag && null === t.tag || (this.tag = null === t.tag ? "PNotify-" + Math.round(1e6 * Math.random()) : t.tag), i.desktop = _n(t.title || i.options.title, {
        icon: this.icon,
...
!function (i, o) {
  "function" == typeof define && define.amd ? define("pnotify.mobile", ["jquery", "pnotify"], o) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = o(require("jquery"), require("./pnotify")) : o(i.jQuery, i.PNotify);
...
//# sourceMappingURL=pnotify.custom.min.js.map
